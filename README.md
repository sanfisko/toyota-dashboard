# <img src="static/toyota-logo.svg" alt="Toyota" width="32" height="32"> Toyota Dashboard
...
- **<img src="static/toyota-logo.svg" alt="Toyota" width="16" height="16"> Управление** - дистанционные команды
...
- **Fallback** на Словению при отсутствии GPS
- **Ручное обновление** через веб-интерфейс

### 🇸🇮 Для Словении
- **Цена бензина**: 1.43€/л (актуальная с сайта)
- **Автоматическое определение** по координатам Любляны
- **Расчет экономии** в евро для местных условий

### ⚡ Быстрый тест
1. Откройте `/stats`
2. Нажмите "🧪 Добавить тестовые данные"
3. Проверьте экономию в евро (~4€ для Словении)
4. Нажмите "🌐 Загрузить с сайта" для обновления цен
5. Убедитесь в правильном определении страны

### 🌍 Поддерживаемые страны
**Самые дорогие**: Нидерланды (2.10€/л), Исландия (1.99€/л), Великобритания (1.92€/л)
**Самые дешевые**: Россия (0.69€/л), Молдавия (1.17€/л), Болгария (1.21€/л)
**Словения**: 1.43€/л
...
**Сделано с ❤️ для сообщества Toyota** <img src="static/toyota-logo.svg" alt="Toyota" width="20" height="20">✨